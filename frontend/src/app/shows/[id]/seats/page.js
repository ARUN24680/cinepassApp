      ...
      <div className="w-full flex flex-col md:flex-row gap-gutter items-start justify-center">
        ...
        <aside className="w-full md:w-80 glass-panel rounded-2xl p-6 sticky top-28 action-glow">
          ...
          <button
            ...
            className={`w-full bg-inverse-primary hover:bg-on-primary-fixed-variant text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg active:scale-95 flex items-center justify-center gap-2 ${selectedSeats.length === 0 || locking ? 'opacity-50 cursor-not-allowed' : ''
              }`}
          >
